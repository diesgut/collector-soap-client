...
public enum PagoRsFieldEnum {
	...
	// DE(125) RESPUESTA DE REQUERIMIENTO	
	...
	FILLER1(217,226,"",AlignFillEnum.RIGHT),
	...
	FILLER2(317,336,"",AlignFillEnum.RIGHT),
	...
	FILLER3(448,467,"",AlignFillEnum.RIGHT),
	...
	IMPORTE_PAGADO(541,551,"0",AlignFillEnum.LEFT),
	CODIGO_DE_CONCEPTO_1(552,553,"",AlignFillEnum.RIGHT),
	IMPORTE_CONCEPTO_1(554,564,"0",AlignFillEnum.LEFT),
	CODIGO_DE_CONCEPTO_2(565,566,"",AlignFillEnum.RIGHT),
	IMPORTE_CONCEPTO_2(567,577,"0",AlignFillEnum.LEFT),
	CODIGO_DE_CONCEPTO_3(578,579,"",AlignFillEnum.RIGHT),
	IMPORTE_CONCEPTO_3(580,590,"0",AlignFillEnum.LEFT),
	CODIGO_DE_CONCEPTO_4(591,592,"",AlignFillEnum.RIGHT),
	IMPORTE_CONCEPTO_4(593,603,"0",AlignFillEnum.LEFT),
	CODIGO_DE_CONCEPTO_5(604,605,"",AlignFillEnum.RIGHT),
	IMPORTE_CONCEPTO_5(606,616,"0",AlignFillEnum.LEFT),
	...
	FILLER4(645,678,"",AlignFillEnum.RIGHT),
	;
	...
	private PagoRsFieldEnum(Integer startPosition, Integer endPosition, String dataFill, AlignFillEnum ortientationFillEnum) {
